...
plot(data$length, data$whole_weight,'p',main = "Зависимость веса от длины")
...
data.without.emmision.of.height <- data[data$height<0.4]
linear.model.3 <- lm (whole_weight ~ height, data=data.without.emmision.of.height)
linear.model.3
